...
var Shopify_vendor_report = new mongoose.Schema({
		
				shop_id: { type: String},	
				month_id: { type: String},	
				month_vendor_id: { type: String, unique: true },
				year:{ type: Number },	
				month:{ type: String },	
				rank:{ type: Number },	
				name:{ type: String },
...
Shopify_vendor_report.set('toJSON', {
   virtuals: true
});

module.exports = mongoose.model('Shopify_vendor_report', Shopify_vendor_report);
