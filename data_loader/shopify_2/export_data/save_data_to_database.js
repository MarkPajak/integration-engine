...
console.log(" add_data_to_database")
			...
			async.forEach(google_data, function(_product, cbb) {				
							 ...
							 new_product_month.month_id=options.year+options.month+_product.variant_id
							 ...
							 new_product_month.gross_sales=_product.gross_sales        //net_quantity
						...
						//	 new_product_month.order_cost=_product.order_cost
						    ...
						    shopify_monthly.save(function(){	 cbb()});
