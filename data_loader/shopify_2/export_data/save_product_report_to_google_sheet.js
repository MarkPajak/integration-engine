...
var sheet_name = "_"+options.month//+"_"+moment(new Date()).format('DD_MM_YYYY')
...
/*
     function setHeaderRow(step) {
		 ...
		 headers.push("count") 		        //net_quantity
		 headers.push("gross_sales")        //net_quantity
		 headers.push("discounts") 	        //>>
		 headers.push("returns")		    //>>
		 headers.push("net_sales") 	        //>>
		 headers.push("taxes") 			    //>>
		 headers.push("total_sales") 		//>>
