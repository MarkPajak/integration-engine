...
var transactions_data_to_google_sheet = require("../analyse_data/monthly_sales_by_product.js");
...
var Monthlytotals = require("../analyse_data/monthly_sales_by_product.js");
...
this.go = function(done,cb){
	...
	var shopifydata
		...
		function save_to_csv(callback) {
			...
			data_save_to_csv.save_csv(shopifydata,function(analytics_data) {
