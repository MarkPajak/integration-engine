exports.weekly_operations_controller = function($route,$scope, $http, $q, $routeParams, $location,$rootScope, Weekly_operations,make_a_pie,make_a_line_chart,weekly_data_table_columns,grid_ui_settings,table_security
    ) {
		...
		$scope.table_heading = "Weekly operations stats"
		...
		var columnDefs= []
			...
			Weekly_operations.query({}, function(team) {
				$scope.rows=[]
				$scope.data_rows=[]
				$scope._rows=[]
